...
class CHVD_dialog
{
	...
	class controls
	{
		class CHVD_rscFootViewSlider: CHVD_rscXSliderH
		{
			idc = 1900;
			type = 43;
			onSliderPosChanged = "['RW_foot', _this select 0, _this select 1, 1006, 'RW_footObj', 1901, 1007, 'RW_footSyncMode', 'RW_footSyncPercentage'] call CHVD_fnc_onSliderChange";
		...
		class CHVD_rscFootObjSlider: CHVD_rscXSliderH
		{
			idc = 1901;
			type = 43;
			onSliderPosChanged = "['RW_footObj', _this select 0, _this select 1, 1007] call CHVD_fnc_onSliderChange";
		...
		class CHVD_rscCarViewSlider: CHVD_rscXSliderH
		{
			idc = 1902;
			type = 43;
			onSliderPosChanged = "['RW_car', _this select 0, _this select 1, 1013, 'RW_carObj', 1903, 1014, 'RW_carSyncMode', 'RW_carSyncPercentage'] call CHVD_fnc_onSliderChange";
		...
		class CHVD_rscCarObjSlider: CHVD_rscXSliderH
		{
			idc = 1903;
			type = 43;
			onSliderPosChanged = "['RW_carObj', _this select 0, _this select 1, 1014] call CHVD_fnc_onSliderChange";
		...
		class CHVD_rscAirViewSlider: CHVD_rscXSliderH
		{
			idc = 1904;
			type = 43;
			onSliderPosChanged = "['RW_air', _this select 0, _this select 1, 1017, 'RW_airObj', 1905, 1018, 'RW_airSyncMode', 'RW_airSyncPercentage'] call CHVD_fnc_onSliderChange";
		...
		class CHVD_rscAirObjSlider: CHVD_rscXSliderH
		{
			idc = 1905;
			type = 43;
			onSliderPosChanged = "['RW_airObj', _this select 0, _this select 1, 1018] call CHVD_fnc_onSliderChange";
		...
		{
			idc = 1006;
			onKeyDown = "['RW_foot', 1900, _this select 0, 'RW_footObj', 1901, 1007, 'RW_footSyncMode', 'RW_footSyncPercentage'] call CHVD_fnc_onEBinput";
			maxChars = 5;
		...
		{
			idc = 1007;
			onKeyDown = "['RW_footObj', 1901, _this select 0] call CHVD_fnc_onEBinput";
			maxChars = 5;
		...
		{
			idc = 1013;
			onKeyDown = "['RW_car', 1902, _this select 0, 'RW_carObj', 1903, 1014, 'RW_carSyncMode', 'RW_carSyncPercentage'] call CHVD_fnc_onEBinput";
			maxChars = 5;
		...
		{
			idc = 1014;
			onKeyDown = "['RW_carObj', 1903, _this select 0] call CHVD_fnc_onEBinput";
			maxChars = 5;
		...
		{
			idc = 1017;
			onKeyDown = "['RW_air', 1904, _this select 0, 'RW_airObj', 1905, 1018, 'RW_airSyncMode', 'RW_airSyncPercentage'] call CHVD_fnc_onEBinput";
			maxChars = 5;
		...
		{
			idc = 1018;
			onKeyDown = "['RW_airObj', 1905, _this select 0] call CHVD_fnc_onEBinput";
			maxChars = 5;
		...
		{
			idc = 1400;
			onKeyDown = "['RW_footTerrain', 1400, 1500] call CHVD_fnc_onEBterrainInput";
			maxChars = 5;
		...
		{
			idc = 1401;
			onKeyDown = "['RW_carTerrain', 1401, 1501] call CHVD_fnc_onEBterrainInput";
			maxChars = 5;
		...
		{
			idc = 1402;
			onKeyDown = "['RW_airTerrain', 1402, 1502] call CHVD_fnc_onEBterrainInput";
			maxChars = 5;
